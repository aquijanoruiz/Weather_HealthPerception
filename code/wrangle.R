...
save(Weather_HealthPerception_2012data, file = "data/Weather_HealthPerception_2012data.RData")
write_dta(Weather_HealthPerception_2012data, path = "data/Weather_HealthPerception_2012data.dta")
